...
**Latest release**: January 12, 2020 • version 4.8.1 • [CHANGELOG](CHANGELOG.md) • [Migrating From GRDB 3 to GRDB 4](Documentation/GRDB3MigrationGuide.md)
...
| ------------- | ----------------------------------------------------------- |
| **Swift 5.1** | **v4.8.1**                                                  |
| Swift 5       | [v4.8.1](https://github.com/groue/GRDB.swift/tree/v4.8.1)   |
| Swift 4.2     | [v4.8.1](https://github.com/groue/GRDB.swift/tree/v4.8.1)   |
...
- [GRDB Reference](http://groue.github.io/GRDB.swift/docs/4.8/index.html) (generated by [Jazzy](https://github.com/realm/jazzy))
...
See [Configuration](http://groue.github.io/GRDB.swift/docs/4.8/Structs/Configuration.html) for more details.
...
See [Values](#values) for more information on supported arguments types (Bool, Int, String, Date, Swift enums, etc.), and [StatementArguments](http://groue.github.io/GRDB.swift/docs/4.8/Structs/StatementArguments.html) for a detailed documentation of SQLite arguments.
...
Values can be used as [statement arguments](http://groue.github.io/GRDB.swift/docs/4.8/Structs/StatementArguments.html):
...
Transactions can't be left opened unless you set the [allowsUnsafeTransactions](http://groue.github.io/GRDB.swift/docs/4.8/Structs/Configuration.html) configuration flag:
...
Row adapters are values that adopt the [RowAdapter](http://groue.github.io/GRDB.swift/docs/4.8/Protocols/RowAdapter.html) protocol. You can implement your own custom adapters ([**:fire: EXPERIMENTAL**](#what-are-experimental-features)), or use one of the four built-in adapters, described below.
...
See [fetching methods](#fetching-methods) for information about the `fetchCursor`, `fetchAll` and `fetchOne` methods. See [StatementArguments](http://groue.github.io/GRDB.swift/docs/4.8/Structs/StatementArguments.html) for more information about the query arguments.
...
See [DatabaseDateDecodingStrategy](https://groue.github.io/GRDB.swift/docs/4.8/Enums/DatabaseDateDecodingStrategy.html), [DatabaseDateEncodingStrategy](https://groue.github.io/GRDB.swift/docs/4.8/Enums/DatabaseDateEncodingStrategy.html), and [DatabaseUUIDEncodingStrategy](https://groue.github.io/GRDB.swift/docs/4.8/Enums/DatabaseUUIDEncodingStrategy.html) to learn about all available strategies.
...
Raw SQL snippets are also accepted, with eventual [arguments](http://groue.github.io/GRDB.swift/docs/4.8/Structs/StatementArguments.html):
...
- [SQLRequest](http://groue.github.io/GRDB.swift/docs/4.8/Structs/SQLRequest.html) is a fetch request built from raw SQL. For example:
...
- [AnyFetchRequest](http://groue.github.io/GRDB.swift/docs/4.8/Structs/AnyFetchRequest.html): a [type-erased](http://chris.eidhof.nl/post/type-erasers-in-swift/) request.
...
**[DatabaseRegion](https://groue.github.io/GRDB.swift/docs/4.8/Structs/DatabaseRegion.html) is a type that helps observing changes in the results of a database [request](#requests)**.
...
For more details, see the [reference](http://groue.github.io/GRDB.swift/docs/4.8/Structs/DatabaseRegion.html#/s:4GRDB14DatabaseRegionV10isModified2bySbAA0B5EventV_tF).
...
Both DatabaseQueue and DatabasePool adopt the [DatabaseReader](http://groue.github.io/GRDB.swift/docs/4.8/Protocols/DatabaseReader.html) and [DatabaseWriter](http://groue.github.io/GRDB.swift/docs/4.8/Protocols/DatabaseWriter.html) protocols. DatabaseSnapshot adopts DatabaseReader only.
